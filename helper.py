...
displayStartText = fontMono.render("START SCREEN", False, (0, 0, 0))
displaySettingText = fontMono.render("SETTINGS", False, (0, 0, 0))
displayScoreText = fontMono.render("HIGH SCORE: ", False, (0, 0, 0))
